...
export class FCMService {
	...
	constructor( public platform: Platform, private device: Device, public alertCtrl: AlertController, private app:App, protected http:HttpService, private fcm: FCM, protected storage:LocalStorageService) {//, private platformService: PlatformService
